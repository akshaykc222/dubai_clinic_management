...
import 'package:dubai_clinic_management/screens/products/componets/search.dart';
              ...
              children: [
                Row(
                  ...
                  children:const [
                    ...
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text('Service',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.bold),),
                    ),
                  ]
                ),
                      ...
                      child: Container(
                        ...
                        child: Center(
                          ...
                          child: Row(
                            ...
                            children: const [Icon(Icons.add,color: Colors.white,),Text('add',style: TextStyle(color: Colors.white),)],),),
                      ),
                    ),
                  )
                ],)
              ...
              children: [
                Row(
                    ...
                    children:const [
                      ...
                      Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text('Product',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.bold),),
                      ),
                    ]
                ),
