...
import 'package:dubai_clinic_management/screens/services/componets/category.dart';
    ...
    return Column(
      children: [
        ...
        InkWell(
            ...
            child:visible?const Icon(Icons.keyboard_arrow_up,size: 35,):const Icon(Icons.keyboard_arrow_down,size: 35,))
      ],
    );
  }
}
