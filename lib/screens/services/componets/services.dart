...
class _ServicesAddServiceState extends State<ServicesAdd> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar("Services/products"),
      body: Stack(children: [
        Column(
          children: [
            Row(
        ...
        Positioned(
            ...
            child: InkWell(
                ...
                child: defaultButton("Place order", context)))
      ]),
    );
  }
}
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          columUserTextFileds("discount price"),
          columUserTextFileds("actual price"),
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
            child: DropdownButtonFormField(
              // Initial Value
          ...
          columUserTextFileds("duration(optional)"),
          columUserTextFileds("expiray date(optional)"),
